from canada_id.codec._pdf417dec import Modulus
from canada_id.codec._pdf417dec.Polynomial import ONE, ZERO, Polynomial
...
def test_codewords(codewords: list, error_correction_length: int) -> tuple:
    ...
    for i in range(error_correction_length, 0, -1):
        ...
        # Original: Syndrome[ECL - Index] = PolyCodewords.EvaluateAt(Modulus.ExpTable[Index])
...
def euclidean_algorithm(
    error_correction_length: int, poly_r: Polynomial
) -> tuple[bool, Polynomial, Polynomial]:
